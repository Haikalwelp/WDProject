                            ...
                            <div class="modal-body">
                                <form method="POST" enctype="multipart/form-data" id="editProductForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="editProductSelling"
                                            name="editProductSelling">
                                    </div>
                                    <div class="mb-3">
                                        <label for="editProductBalance" class="form-label">Balance</label>
                                        <input type="text" class="form-control" id="editProductBalance"
                                            name="editProductBalance">
                                    </div>
                                    <div class="mb-3">
                                        <label for="currentProductPhoto" class="form-label">Current Product
                                            Photo</label>
                                        <img src="" id="currentProductPhoto" width="200" height="200"
                                            alt="Current Product Photo">
                                    </div>
                                    <div class="mb-3">
                                        <label for="editProductPhoto" class="form-label">New Product Photo</label>
                                        <input type="file" class="form-control" id="editProductPhoto"
                                            name="editProductPhoto">
                                    </div>
